...
def generate_excel_template():
    ...
    buffer = io.BytesIO()
    # שימוש ב-openpyxl למניעת שגיאות
    ...
    if not df.empty:
        ...
        edited_df = st.data_editor(
            ...
            column_config={
                ...
                # ניתן להסתיר עמודות נוספות אם רוצים שיהיה נקי יותר
            },
            hide_index=True,
...
def main_app():
    ...
    if user_role == 'admin':
        ...
        # 7. ממשק מחיקה בטאב נפרד (עם הצ'קבוקסים)
        with tabs[6]:
